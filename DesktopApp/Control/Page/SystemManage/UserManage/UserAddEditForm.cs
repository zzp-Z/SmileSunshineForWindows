...
namespace DesktopApp.Control.Page.SystemManage.UserManage
{
    public partial class UserAddEditForm : Form
    {
        ...
        private bool ValidateInput()
        {
            ...
            {
                MessageBox.Show("Please enter your real name.", "Validation error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
            ...
            {
                MessageBox.Show("Please select the department.", "Validation error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }

            if (roleComboBox.SelectedValue == null)
            {
                MessageBox.Show("Please select the role.", "Validation error", MessageBoxButtons.OK, MessageBoxIcon.Warning);
                return false;
            }
